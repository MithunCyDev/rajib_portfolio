            ...
            <div className="container mx-auto max-w-6xl">
                <div className="flex flex-col md:flex-row items-center gap-8 md:gap-16">
                    <div className="w-full md:w-1/2 space-y-6">
                        <div>
                            <AnimatedText text="Rajib Ahamed" className="text-4xl md:text-5xl font-bold tracking-tight" />
                            <AnimatedText
                        ...
                        >
                            Building scalable and modern full-stack applications with a focus on clean architecture, intuitive design, and
                        ...
                        >
                            ...
                            <Button variant="secondary" asChild className="relative overflow-hidden group">
                                <Link href="/documents/rajib-ahamed-resume.pdf" target="_blank" download>
                    ...
                    >
                        <div className="relative w-64 h-64 md:w-80 md:h-80 rounded-full overflow-hidden border-4 border-white dark:border-gray-800 shadow-xl">
                            <Image src="/images/profile.jpg" alt="Rajib Ahamed" fill className="object-cover" priority />
                ...
                >
                    <Link href="#about" className="text-gray-400 hover:text-purple-600 dark:hover:text-purple-400 transition-colors">
